...
class MyCap:
    ...
    def read(self):
        ...
        if ret == False:
            return None
        resize = cv2.resize(frame, (self.frameWidth,self.frameHeight))
        return Image.fromarray(resize)
...
class CoralDetector:
    ...
    def classify_frame(self):
        while True:
            ...
            #shove it to CORAL USB stick (this is blocking)
...
#init video stream and detector
